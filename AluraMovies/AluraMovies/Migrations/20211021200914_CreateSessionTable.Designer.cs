...
namespace AluraMovies.Migrations
{
    ...
    [Migration("20211021200914_CreateSessionTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AluraMovies.Models.Session", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AluraMovies.Models.Session", b =>
                {
                    b.HasOne("AluraMovies.Models.Movie", "Movie")
                        .WithMany("Sessions")
                        .HasForeignKey("MovieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AluraMovies.Models.MovieTheater", "MovieTheater")
                        .WithMany("Sessions")
